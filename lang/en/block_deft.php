...
$string['deftsettings_desc'] = 'If hosted Deftly server is selected for updating content, then access should be enabled below.';
...
$string['enablebridge_desc'] = 'If a server is configured for updating content, this will enable it to be used also as an audio bridge. An option to use it will appear when editing a venue. The bridge allows more participants in the venue and better audio quality. You will need access to {$a} or install a Jitsi server and complete the appropriate settings section below.';
...
$string['enableupdating_desc'] = 'Select a server type to use. You will also need to complete the section for the selected server type. If none is selected, content will only be updated when page reloads.';
$string['enablevideo'] = 'Enable video';
$string['enablevideo_desc'] = 'This makes the button to share video feed appear for users with <em>Share video</em> capability. You will also need access to {$a} or a Jitsi Meet server configured.';
