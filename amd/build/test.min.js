...
/*
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=void 0,_ajax=_interopRequireDefault(_ajax),_fragment=_interopRequireDefault(_fragment),_log=_interopRequireDefault(_log),_notification=_interopRequireDefault(_notification),_socket=_interopRequireDefault(_socket),Toast=function(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule)return obj;if(null===obj||"object"!=typeof obj&&"function"!=typeof obj)return{default:obj};var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj))return cache.get(obj);var newObj={},hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj)if("default"!==key&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;desc&&(desc.get||desc.set)?Object.defineProperty(newObj,key,desc):newObj[key]=obj[key]}newObj.default=obj,cache&&cache.set(obj,newObj);return newObj}(Toast);var _default={init:function(contextid){_log.default.debug("Requesting token"),_ajax.default.call([{methodname:"block_deft_renew_token",args:{contextid:contextid},done:token=>{(0,_str.get_string)("authorizationreceived","block_deft").done((message=>{Toast.add(message,{type:"info"})})),_socket.default.open(contextid,token.token).subscribe((()=>{(0,_str.get_string)("messagereceived","block_deft").done((message=>{Toast.add(message,{type:"success"})}))})),setTimeout((()=>{_fragment.default.loadFragment("block_deft","test",contextid,{}).done((message=>{Toast.add(message,{type:"info"})})).fail(_notification.default.exception)}),500)},fail:_notification.default.exception}])}};return _exports.default=_default,_exports.default}));
