...
/*
   ...
   */var contextid;Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.init=void 0,_modalform=_interopRequireDefault(_modalform),_templates=_interopRequireDefault(_templates),_log=_interopRequireDefault(_log);var submitForm=function(e){_log.default.debug("Form submitted"),_log.default.debug(e.detail),e.detail&&e.detail.html&&_templates.default.replaceNodeContents(document.querySelector(".tasks"),e.detail.html)},handleSubmit=function(e){if(e.target.matches("form")){var title,formdata=new FormData(e.target),id=formdata.get("id"),type=formdata.get("type")||e.submitter.value,action="action"===e.submitter.name&&e.submitter.value;switch(e.preventDefault(),e.stopPropagation(),"delete"!==action&&"move"!==action||(type=action),action){case"delete":title=(0,_str.get_string)("confirm","core");break;case"move":title=(0,_str.get_string)("move","core");break;case"status":title=(0,_str.get_string)("changestatus","block_deft");break;default:title=(0,_str.get_string)("edit"+type,"block_deft")}_log.default.debug("Create "+type);var modalForm=new _modalform.default({formClass:"block_deft\\form\\"+("status"===action?"status_":"edit_")+type,args:{contextid:contextid,id:id},modalConfig:{title:title}});modalForm.addEventListener(modalForm.events.FORM_SUBMITTED,submitForm),modalForm.show()}};_exports.init=function(id){contextid=id,document.removeEventListener("submit",handleSubmit),document.addEventListener("submit",handleSubmit)}}));
