...
class mute_switched extends base {
    ...
    public static function get_name() {
        return get_string('eventmuteswitched', 'block_deft');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' switched mute '" . ($this->other['status'] ? 'on' : 'off')
            . "' in venue for task with id '$this->objectid'.";
    }
}
